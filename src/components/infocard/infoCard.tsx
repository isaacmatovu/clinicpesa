  ...
  return (
    <div className="-mt-8">
      <div className="bg-white mx-6 rounded-2xl shadow-2xl">
        ...
        <div className="flex justify-center sm:justify-around items-end">
        ...
        <div className="flex justify-center  gap-4 items-center mt-5">
          <div className="flex justify-center sm:justify-around gap-4 sm:gap-60 items-center border-b-[0.5px] border-gray-200 pb-2 px-4">
            <div className="flex gap-1">
              <p className="text-neutral-500 text-xs sm:text-2xl">Frequency:</p>
              <p className="text-neutral-500 font-medium text-xs sm:text-2xl">
                Monthly
              </p>
            </div>
            <div className="flex">
              <div className="text-gray-600 flex gap-1">
                <p className="text-xs sm:text-2xl text-neutral-500">AutoSave</p>
                <p className="text-xs sm:text-2xl text-neutral-500">amount:</p>
              </div>
              <div className="text-neutral-700 font-medium flex gap-1">
                <p className="text-xs sm:text-2xl text-neutral-500">UGX </p>
                <p className="text-xs sm:text-2xl text-neutral-500">1,000</p>
              </div>
            </div>
          </div>
        </div>
        <div className="flex justify-center sm:justify-around mt-2 pb-3">
